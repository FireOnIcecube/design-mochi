...
<template>
  ...
  <button
    @click="toggleDrawer"
    class="fixed right-4 bottom-4 rounded-full bg-blue-500 p-3 text-white shadow-lg hover:bg-blue-600"
  >
    Open Drawer
  </button>
  ...
  <transition name="slide">
    <div v-if="isOpen" class="fixed top-0 right-0 z-20 h-full w-64 bg-white p-4 shadow-lg">
