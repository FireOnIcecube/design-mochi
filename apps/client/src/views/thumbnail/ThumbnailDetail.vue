  ...
  <div v-if="enrichedThumbnail">
    ...
    <div class="flex flex-col justify-around lg:flex-row">
      <div class="w-full lg:w-1/2">
        <div
          class="flex select-none items-center justify-center rounded bg-gray-100 dark:bg-gray-400"
        >
      ...
      <div class="w-full lg:w-1/3">
        ...
        <section
          ...
          class="border-outline text-content dark:text-content-dark flex flex-col justify-items-center gap-y-8 border-b-2 pb-6 pt-3"
        >
          <div
          ...
          >
            <div class="font-notosans whitespace-nowrap text-xl">{{ cat?.categoryName }}:</div>
      ...
      <div class="flex flex-col gap-4 md:flex-row md:justify-between">
        ...
        <template v-if="prev">
          <router-link
            ...
            class="border-outline md:max-w-1/2 block w-full cursor-pointer rounded-xl border p-4 shadow-md hover:bg-gray-100 hover:shadow-lg xl:max-w-2xl dark:hover:bg-gray-800"
          >
        ...
        <template v-if="next">
          <router-link
            ...
            class="border-outline hover:bg-surface-hover dark:hover:bg-surface-hover-dark md:max-w-1/2 block w-full cursor-pointer rounded-xl border p-4 shadow-md hover:shadow-lg lg:max-w-2xl xl:max-w-2xl"
          >
